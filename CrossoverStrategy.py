...
class MovingAverageCross:
    ...
    def simulate(self):
        # Consider all the trading days to determine if we want to open a long position
        price_when_buy = 0
    ...
    def plot_equity(self):
        ...
        print("Actual capital: $%02.f" % self.equity[-1])
        plt.figure(figsize=(12, 6))
...
if __name__ == '__main__':
    ...
    strategy = MovingAverageCross(100, 'MSFT', start_date, end_date, 30, 100)
